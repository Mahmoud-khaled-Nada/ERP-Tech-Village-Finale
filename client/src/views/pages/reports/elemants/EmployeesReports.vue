        ...
        <VForm @submit.prevent="getReportByName">
          <VRow>
            ...
            <VCol cols="12" md="3" class="mt-2">
              <VBtn class="mx-4 rep-btn" type="submit"> Submit </VBtn>
        ...
        <VCard class="mb-2 mr-2">
          ...
          <VCardText class="d-flex justify-center">
            <div class="me-auto">
              ...
              <p class="d-flex align-center">
                <VIcon color="primary" icon="bx-building-house" />
            ...
            <div class="ms-auto ps-4">
              <p class="d-flex align-center mb-2">
                <VIcon color="primary" icon="bxs-calendar" />
                <span class="ms-3">Date: {{ item.report_date }}</span>
              </p>
              <p class="d-flex align-center">
                <VIcon color="primary" icon="bxs-hourglass" />
          ...
          <v-expand-transition>
            <div v-show="isCardOpen(item.id)">
              <v-divider />
              <v-card-text v-html="item.report_data"> </v-card-text>
            </div>
          </v-expand-transition>
        </VCard>
      </VCol>
